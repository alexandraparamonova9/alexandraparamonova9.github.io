...
<head>
    ...
    <title>Лабораторная работа №4 — Scikit-Learn</title>
...
<main class="container">
    ...
    <div class="lab-header animate-on-scroll">
        ...
        <h1 class="lab-title">Классификация с применением Scikit-Learn</h1>
    </div>
    ...
    <div class="card animate-on-scroll">
        ...
        <div class="best-model">
            <span class="badge">🏆 Лучшая модель</span>
            <p style="margin-top: 10px; font-weight: 500;">XGBoost с наивысшим значением ROC-AUC</p>
        </div>
    ...
    <div class="card animate-on-scroll" style="text-align: center;">
        ...
        <div style="margin: 24px 0;">
            <a href="https://colab.research.google.com/drive/1OPMfk9i1ROD3h0M0zcsWm4u4hEmMiS0z#scrollTo=CFPdG8_dK7gC" class="colab-link" target="_blank" rel="noopener noreferrer">
        ...
        <p style="color: #677178; font-size: 0.85rem;">Лабораторная работа №4 — полный код и анализ</p>
    </div>
...
<footer class="footer">
    <div class="container">
        Alexandra Paramonova • P3122 • Лабораторная работа №4
    </div>
</footer>
