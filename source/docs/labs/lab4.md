...
<head>
    ...
    <title>Лабораторная работа №4 — Scikit-Learn Классификация | Александра Парамонова</title>
...
<div class="container">
    ...
    <div class="section" id="goal">
        <h3>🎯 Цель работы</h3>
        <p>Освоить применение алгоритмов машинного обучения для решения задачи классификации на примере предсказания дефолта по кредиту. Изучить предобработку данных, обучение моделей и оценку их качества с помощью библиотеки Scikit-Learn.</p>
    </div>
    ...
    <div class="section" id="independent">
        ...
        <p>Исследованы дополнительные модели классификации:</p>
        <ul>
            <li><strong>KNeighborsClassifier</strong> — метод k-ближайших соседей</li>
            <li><strong>Support Vector Machine (SVM)</strong> — метод опорных векторов</li>
            <li><strong>RandomForestClassifier</strong> — случайный лес</li>
            <li><strong>XGBoost Classifier</strong> — градиентный бустинг</li>
        </ul>
        <p><strong>Лучшая модель:</strong> XGBoost с наивысшим значением ROC-AUC.</p>
        <p>Также изучены современные подходы к классификации (градиентный бустинг) и описан способ интеграции обученной модели в веб-сервис на FastAPI.</p>
    </div>

    <div class="section" id="link">
        <h3>🔗 Ссылка на выполненный ноутбук</h3>
        <a href="https://colab.research.google.com/drive/1OPMfk9i1ROD3h0M0zcsWm4u4hEmMiS0z#scrollTo=CFPdG8_dK7gC" class="colab-link" target="_blank">
    ...
    <div class="section" id="conclusion">
        <h3>📌 Вывод</h3>
        <p>В ходе выполнения лабораторной работы была решена задача бинарной классификации с помощью библиотеки Scikit-Learn. Проведена полная предобработка данных, обучено несколько моделей, выбрана лучшая. Получены практические навыки работы с алгоритмами машинного обучения и оценки их качества.</p>
    </div>
</div>
